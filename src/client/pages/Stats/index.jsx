...
const Stats = () => {
  ...
  const [stats, setStats] = useState({
    ucana: { price: 0, total: 0 },
    ucane: { price: 0, total: 0 },
    ucanu: { price: 0, total: 0 },
  });
    ...
    <div className="container p-5" style={{ maxWidth: "700px" }}>
      <div className="card shadow-sm p-5 text-center">
        ...
        <table className="table table-borderless text-center">
          ...
          <tbody>
            <tr>
              <td className="h4 font-weight-bold">{stats.ucana.price || 0}</td>
              <td className="h4 font-weight-bold">{stats.ucane.price || 0}</td>
              <td className="h4 font-weight-bold">{stats.ucanu.price || 0}</td>
            </tr>
          </tbody>
        </table>
